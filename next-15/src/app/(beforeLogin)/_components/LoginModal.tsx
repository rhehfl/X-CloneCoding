...
export default function LoginModal() {
  ...
  return (
    <div className="flex bg-[rgba(0,0,0,0.4)] h-screen justify-center w-screen ] absolute items-center left-0 top-0">
      <div className="flex flex-col bg-white h-[450px] rounded-[16px] max-w-[80vw] min-w-[600px] relative top-[-5%]">
        ...
        <div className="flex flex-col h-full px-[80px]">
          ...
          <form className="flex flex-col h-full justify-between">
            ...
            <div className="py-[24px]">
              <button
                className="bg-[rgb(15,20,25,0.44)] h-[50px] rounded-[24px]
            text-white w-full cursor-pointer
              hover:bg-[rgb(15,20,25)]"
              >
                로그인하기
              </button>
            </div>
