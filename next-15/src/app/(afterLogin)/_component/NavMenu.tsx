  ...
  return (
    <>
      {NAV_MENU.map((menu) => {
        ...
        return (
          <li key={menu.id}>
            <Link href={menu.route} className="flex group">
              <div className="p-[12px] flex justify-center items-center h-[50px] group-hover:rounded-[29px] group-hover:bg-[rgba(15,20,25,0.1)]">
                {isActive ? menu.activeSvg : menu.inActiveSvg}
                <span
                  className={`text-[20px] ml-[20px] mr-[16px]  ${isActive && 'font-bold'}`}
                >
                  {menu.title}
                </span>
              </div>
      ...
      <li>
        <Link href={`/${me.id}`} className="flex group">
          <div className="p-[12px] flex justify-center items-center h-[50px] group-hover:rounded-[29px] group-hover:bg-[rgba(15,20,25,0.1)]">
            {segment === me.id ? (
              <>
                <svg
                ...
                <span className="text-[20px] ml-[20px] mr-[16px]">프로필</span>
              </>
            ) : (
              <>
                <svg
                ...
                <span className="text-[20px] ml-[20px] mr-[16px] font-bold">
                  프로필
                </span>
              </>
            )}
