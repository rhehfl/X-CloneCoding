...
export default function NavMenu() {
  ...
  return (
    <>
          ...
          <li key={menu.id}>
            <Link href={menu.route} className="group flex">
              <div className="flex h-[50px] items-center justify-center p-[12px] group-hover:rounded-[29px] group-hover:bg-[rgba(15,20,25,0.1)]">
                ...
                <span
                  className={`mr-[16px] ml-[20px] text-[20px] ${isActive && 'font-bold'}`}
                >
                  {menu.title}
                </span>
              </div>
      ...
      <li>
        <Link href={`/${me.id}`} className="group flex">
          <div className="flex h-[50px] items-center justify-center p-[12px] group-hover:rounded-[29px] group-hover:bg-[rgba(15,20,25,0.1)]">
            {segment === me.id ? (
              <>
                <svg
                ...
                <span className="mr-[16px] ml-[20px] text-[20px] font-bold">
                  프로필
                </span>
              </>
            ) : (
              <>
                ...
                <span className="mr-[16px] ml-[20px] text-[20px]">프로필</span>
              </>
            )}
          </div>
        </Link>
