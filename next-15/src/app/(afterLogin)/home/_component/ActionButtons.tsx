...
export default function ActionButtons() {
  ...
  return (
    <>
      <div className="mt-3 flex h-[20px] justify-around">
        {/* 댓글 버튼 */}
        <button className="group flex cursor-pointer items-center">
          <div className="relative">
            <div className="absolute inset-1/2 flex h-[34px] w-[34px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full transition-colors duration-200 group-hover:bg-[rgb(29,155,240,0.1)]" />
            <svg
              width={24}
              viewBox="0 0 24 24"
              aria-hidden="true"
        ...
        <button className="group flex cursor-pointer items-center">
          <div className="relative">
            <div className="absolute inset-1/2 flex h-[34px] w-[34px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full transition-colors duration-200 group-hover:bg-[rgb(0,186,124,0.1)]" />
            <svg
              width={24}
              viewBox="0 0 24 24"
              aria-hidden="true"
        ...
        <button className="group flex cursor-pointer items-center">
          <div className="relative">
            <div className="absolute inset-1/2 flex h-[34px] w-[34px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full transition-colors duration-200 group-hover:bg-[rgb(249,24,128,0.1)]" />
            <svg
              width={18.75}
              viewBox="0 0 24 24"
              aria-hidden="true"
